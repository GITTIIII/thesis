...
export function UpdateStudentDialog({ children, user }: { children: React.ReactNode; user: IUser }) {
  ...
  const { data: programData } = useSWR<IProgram[]>("/api/program", fetcher);
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            ...
                            >
                              {field.value
                                ? instituteData?.find((institute) => institute.id === field.value)?.instituteNameTH
                                : "เลือกสำนักวิชา"}
                              <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                          </FormControl>
                              ...
                              <CommandGroup>
                                {instituteData?.map((institute) => (
                                  ...
                                  >
                                    ...
                                    <CheckIcon
                                      className={cn("ml-auto h-4 w-4", institute.id === field.value ? "opacity-100" : "opacity-0")}
                                    />
                                  </CommandItem>
                                ))}
                              </CommandGroup>
                        ...
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              ...
                              className={cn("w-[50dwv] justify-between", !field.value && "text-muted-foreground")}
                            >
                              {field.value ? schoolData?.find((school) => school.id === field.value)?.schoolNameTH : "เลือกสาขาวิชา"}
                              <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                          </FormControl>
                        </PopoverTrigger>
                            ...
                            <CommandList>
                              ...
                              <CommandGroup>
                                {schoolData?.map((school) => (
                                  ...
                                  >
                                    {school.schoolNameTH}
                                    <CheckIcon className={cn("ml-auto h-4 w-4", school.id === field.value ? "opacity-100" : "opacity-0")} />
                                  </CommandItem>
                                ))}
                              </CommandGroup>
                            </CommandList>
                        ...
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              ...
                              className={cn("w-[50dwv] justify-between", !field.value && "text-muted-foreground")}
                            >
                              {field.value ? programData?.find((program) => program.id === field.value)?.programNameTH : "เลือกหลักสูตร"}
                              <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                          </FormControl>
                        </PopoverTrigger>
                              ...
                              <CommandGroup>
                                {programData?.map((program) => (
                                  ...
                                  >
                                    ...
                                    <CheckIcon
                                      className={cn("ml-auto h-4 w-4", program.id === field.value ? "opacity-100" : "opacity-0")}
                                    />
                                  </CommandItem>
                                ))}
                              </CommandGroup>
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            ...
                            >
                              {field.value
                                ? advisorData?.find((advisor) => advisor.id === field.value)?.prefix!?.prefixTH +
                              ...
                              <CommandGroup>
                                {advisorData?.map((advisor) => (
                                  ...
                                  >
                                    ...
                                    <CheckIcon
                                      className={cn("ml-auto h-4 w-4", advisor.id === field.value ? "opacity-100" : "opacity-0")}
                                    />
                                  </CommandItem>
                                ))}
                              </CommandGroup>
