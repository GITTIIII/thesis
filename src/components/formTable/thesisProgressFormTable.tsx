...
export default function ThesisProgressFormTable({ userId }: OutlineFormTableProps) {
	...
	return (
		<>
			...
			<div className="w-full h-full flex justify-center items-center">เเบบรายงานความคืบหน้าของการทำวิทยานิพนธ์</div>
				{/* <Table>
					<TableHeader>
						<TableRow>
