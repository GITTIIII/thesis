...
export default function ThesisExamCommitteeFormTable({ userData }: { userData: IUser | undefined }) {
	...
	return (
		...
		<div className="w-full h-full flex justify-center items-center">แบบคำขออนุมัติแต่งตั้งกรรมการสอบวิทยานิพนธ์</div>
				{/* <Table>
					<TableHeader>
						<TableRow>
