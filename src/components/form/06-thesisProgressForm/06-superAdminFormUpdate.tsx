        ...
        <div className="flex flex-col justify-center md:flex-row">
          ...
          <div className="w-full sm:2/4">
            ...
            <div className="w-3/4 mx-auto p-5 flex flex-col item-center justify-center border-2 rounded-lg mb-5 border-[#eeee]">
              ...
              <Textarea className="mt-2" placeholder="มีการเปลี่ยนแปลงดังนี้..." disabled defaultValue={formData?.statusComment} />
            </div>
            <div className="w-3/4 mx-auto p-5 flex flex-col item-center justify-center border-2 rounded-lg mb-5 border-[#eeee]">
                ...
                render={({ field }) => (
                  <div className="flex flex-row items-center mb-6 justify-center">
                    <FormItem className="w-auto">
                      ...
                      <Input value={field.value ? field.value : ""} onChange={(e) => field.onChange(Number(e.target.value))} />
                      <FormMessage />
                    </FormItem>
                  </div>
                )}
        ...
        <div className="h-max flex flex-col justify-center mt-4 sm:mt-0 items-center p-4 lg:px-20">
                  ...
                  <Textarea
                    disabled={
                      formData?.headSchoolComment
                        ? true
                        : false || (user?.position.toString() != "HEAD_OF_SCHOOL" && user?.role.toString() != "SUPER_ADMIN")
                    }
                    placeholder="ความเห็น..."
                    className="resize-none h-full text-md mb-2"
          ...
          <Dialog open={openSchool} onOpenChange={setOpenSchool}>
            <DialogTrigger
              ...
              disabled={
                (formData?.headSchoolSignUrl || user?.position.toString() != "HEAD_OF_SCHOOL") && user?.role.toString() != "SUPER_ADMIN"
                  ? true
                  : false
              }
            >
              ...
              render={({ field }) => (
                <>
                  <Popover>
                    <PopoverTrigger
                      asChild
                      disabled={user?.position.toString() != "HEAD_OF_SCHOOL" && user?.role.toString() != "SUPER_ADMIN"}
                    >
                      <FormControl>
                        <Button
                          variant="outline"
                      ...
                      <Command>
                        ...
                        <CommandList>
                          ...
                          {headSchool?.map((headSchool) => (
                            ...
                            >
                              <Check className={cn("mr-2 h-4 w-4", field.value === headSchool.id ? "opacity-100" : "opacity-0")} />
