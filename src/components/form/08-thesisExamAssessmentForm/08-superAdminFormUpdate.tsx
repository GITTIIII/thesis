...
import { IThesisExamAssessmentForm } from "@/interface/form";
...
const ThesisExamAssessmentFormSuperAdmin = ({ user, formData }: { user: IUser; formData: IThesisExamAssessmentForm }) => {
