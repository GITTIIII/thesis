      ...
      <div className="w-full flex px-0 sm:px-10 mb-2">
				...
				<div className="flex flex-col justify-center md:flex-row">
					...
					<div className="w-full ">
                        ...
                        <InputForm value={`${formData?.examinationDate ? new Date(formData?.examinationDate).toLocaleDateString("th") : ""}`} label="วันที่สอบ / This Examination Date" />
						</div>
                                  ...
                                  <FormControl>
                                    <Textarea
                                      ...
                                      {...field}
                                        ...
                                        value={formData?.presentationComment ? formData?.presentationComment : field.value}
                                ...
                                <FormItem className="w-auto">
                                  ...
                                  <FormControl>
                                    <Textarea
                                        ...
                                        {...field}
                                        placeholder="ความเห็น..."
                                        value={formData?.explanationComment ? formData?.explanationComment : field.value}
										onChange={field.onChange}
                                      />
                                  </FormControl>
                                  <FormMessage />
                                ...
                                <FormItem className="w-auto">
                                  ...
                                  <FormControl>
                                    <Textarea
                                        ...
                                        {...field}
                                        placeholder="ความเห็น..."
                                        value={formData?.answerQuestionsComment ? formData?.answerQuestionsComment : field.value}
										onChange={field.onChange}
                                      />
                                  </FormControl>
                                  <FormMessage />
            ...
            <div>
              <div className="w-full flex flex-row flex-wrap item-center justify-center">
						{formData?.committeeSignUrl?.map((field, index) => (
                                            ...
                                            <SignatureDialog
                                              signUrl={
                                                formData?.committeeSignUrl?.[index]?.signUrl ? formData?.committeeSignUrl?.[index]?.signUrl : ""
                                            }
                                              isOpen={false}
                        ...
                        <div className="w-[88%] mx-auto p-5 flex flex-col item-center justify-center border-2 rounded-lg mb-5 border-[#eeee]">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <div className="flex flex-row items-center m-6 justify-center">
                                            ...
                                            <Input
                                                type="number"
                                                value={formData?.meetingNo? formData?.meetingNo : field.value ? field.value : ""}
							...
							<div className="w-full sm:1/3 flex flex-col items-center mb-6 justify-center">
								...
								<SignatureDialog
									...
									signUrl={formData?.headOfCommitteeSignUrl? formData?.headOfCommitteeSignUrl: form.getValues("headOfCommitteeSignUrl")}
                                    ...
                                    render={({ field }) => (
                                        <div className="flex flex-row items-center justify-center">
                                            ...
                                            <div className="w-[300px] flex item-center justify-center">
                                                <Input type="text"  
                                                value={formData?.headOfCommitteeName ? formData?.headOfCommitteeName : field.value ? field.value : ""}
