...
const formSchema = z.object({
  ...
  thesisStartMonth: z
    .string()
    .min(1, { message: "กรุณาเลือกเดือน / Please select month" }),
  thesisStartYear: z
    .string()
    .min(1, { message: "กรุณากรอกปี พ.ศ. / Year (B.E.) requierd" }),
  formStatus: z.string(),
  studentID: z.number(),
});
        ...
        <div className="flex flex-col justify-center md:flex-row">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col items-center mb-6 justify-center">
              ...
              <Label>{`วันที่ ${
                form.getValues().date
                  ? form.getValues().date.toLocaleDateString("th")
                  : "__________"
              }`}</Label>
            </div>
          </div>
