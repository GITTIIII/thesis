...
export async function GET(request: NextRequest) {
	...
	const data = {
		...
		advisorPrefix: thesisExamCommitteeForm.student.advisor?.prefix?.prefixTH || "",
		advisorFirstName: thesisExamCommitteeForm.student.advisor?.firstNameTH || "",
		advisorLastName: thesisExamCommitteeForm.student.advisor?.lastNameTH || "",
