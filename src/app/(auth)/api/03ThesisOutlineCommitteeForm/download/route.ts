...
export async function GET(request: NextRequest) {
  ...
  const data = {
    ...
    advisorPrefix: thesisOutlineCommitteeForm.advisor.prefix?.prefixTH,
    advisorFirstName: thesisOutlineCommitteeForm.advisor.firstNameTH,
    advisorLastName: thesisOutlineCommitteeForm.advisor.lastNameTH,
