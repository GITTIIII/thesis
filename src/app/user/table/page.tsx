    ...
    <>
      <div className="w-full h-full bg-transparent py-12 px-2 lg:px-28">
        ...
        <div className="h-max w-full flex items-center text-2xl p-2">
          ...
          <label className="ml-5 bg-[#FFF4EF] px-4 text-[#F26522] border-2 border-[#F26522] rounded-lg text-xl">{labels[formType]}</label>
        </div>
        <div className="w-max ml-auto flex flex-col sm:flex-row items-center justify-center">
          <Select onValueChange={handleSelect} defaultValue={searchParams ? searchParams : ""}>
            <SelectTrigger className="w-max">
              <SelectValue placeholder="แบบคำขออนุมัติแต่งตั้งกรรมการสอบประมวลความรู้" defaultValue={"comprehensiveExamCommitteeForm"} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem
        ...
        <div className="h-full w-full flex items-center py-4">
          ...
          {formType == "qualificationExamCommitteeForm" && <QualificationExamCommitteeFormTable userData={userData} />}
