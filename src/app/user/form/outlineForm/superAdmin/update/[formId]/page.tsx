...
import SuperAdminForm05Update from "@/components/form/05-outlineForm/05-superAdminFormUpdate";

export default function SuperAdminForm05UpdatePage({ params }: { params: { formId: number } }) {
      ...
      <div className="w-full h-max bg-transparent py-12 px-2 lg:px-28">
        ...
        <div className="h-full w-full flex items-center bg-[#EEEEEE] p-2 md:p-8 rounded-md">
          <div className="w-full h-full">
            <SuperAdminForm05Update formId={Number(formId)} />
          </div>
        </div>
      </div>
    </>
