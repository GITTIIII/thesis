...
export default async function QualificationExamCommitteeFormUpdatePage({ params }: { params: { formId: number } }) {
			...
			<div className="w-full h-max bg-transparent py-12 px-2 lg:px-28">
				...
				<div className="h-full w-full flex items-center bg-[#EEEEEE] p-2 md:p-8 rounded-md">
					<div className="w-full h-full">
						<QualificationExamCommitteeFormUpdate formData={formData} user={user} headSchool={headSchool} />
					</div>
				</div>
			</div>
		</>
