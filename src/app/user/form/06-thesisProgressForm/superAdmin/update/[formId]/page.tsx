...
import SuperAdminForm06Update from "@/components/form/06-thesisProgressForm/06-superAdminFormUpdate";
...
export default async function SuperAdminForm06UpdatePage({ params }: { params: { formId: number } }) {
			...
			<div className="w-full h-max bg-transparent py-12 px-2 lg:px-28">
				...
				<div className="h-full w-full flex items-center bg-[#EEEEEE] p-2 md:p-8 rounded-md">
					<div className="w-full h-full">
						<SuperAdminForm06Update formData={formData} user={user} approvedForm={approvedForm} headSchool={headSchool} />
					</div>
				</div>
			</div>
		</>
