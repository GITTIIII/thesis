                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      ...
                      >
                        {field.value
                          ? `${instituteData?.find((instituteData) => instituteData.id === field.value)?.instituteNameTH} `
                          : "เลือกสำนักวิชา"}
                    ...
                    <Command>
                      ...
                      <CommandList>
                        ...
                        {instituteData?.map((instituteData) => (
                          ...
                          >
                            <Check className={cn("mr-2 h-4 w-4", field.value === instituteData.id ? "opacity-100" : "opacity-0")} />
                      ...
                      <CommandList>
                        ...
                        {schoolData
                          ...
                          .map((schoolData) => (
                            ...
                            >
                              <Check className={cn("mr-2 h-4 w-4", field.value === schoolData.id ? "opacity-100" : "opacity-0")} />
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      ...
                      >
                        {field.value
                          ? `${programData?.find((programData) => programData.id === field.value)?.programNameTH} `
                          : "เลือกหลักสูตร"}
                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                      </Button>
                    </FormControl>
                    ...
                    <Command>
                      ...
                      <CommandList>
                        ...
                        {programData.map((programData) => (
                          ...
                          >
                            <Check className={cn("mr-2 h-4 w-4", field.value === programData.id ? "opacity-100" : "opacity-0")} />
                      ...
                      <CommandList>
                        ...
                        {allAdvisor
                          ...
                          .map((advisor) => (
                            ...
                            >
                              <Check className={cn("mr-2 h-4 w-4", field.value === advisor.id ? "opacity-100" : "opacity-0")} />
